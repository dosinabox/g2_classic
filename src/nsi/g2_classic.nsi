...
!define MUI_TEXT_WELCOME_INFO_TEXT "Данная модификация позволит вам запускать оригинальную Готику 2 без аддона 'Ночь Ворона'. Установка рекомендуется на русскую версию Золотого Издания от Акеллы с установленным Player Kit или на Steam-версию с установленным Gothic 2 Steam Fix. Сохренения из игры с аддоном не поддерживаются: начало новой игры обязательно!"

!define MUI_TEXT_DIRECTORY_SUBTITLE " "
DirText "Программа установит модификацию в указанную папку.$\n$\nЧтобы установить модификацию в другую папку, нажмите кнопку 'Обзор ...' и укажите ее. Если кнопка 'Далее' остается неактивной, то сначала установите Player Kit (официальный набор для запуска модов) или Gothic 2 Steam Fix."
